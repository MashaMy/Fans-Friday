export const dataPerson = [
    {
      ...
      {
        id: 2,
        name: "Светлана Вальерева",
        description: "Подавайте мне солянку, иначе не пойду",
        age: 24,
    ...
    
      {
        id: 3,
        name: "Игорь Трутнев",
        description: "Мое второе имя Пельмени!",
        age: 32,
    ...
    
      {
        id: 4,
        name: "Дарья Синицкая",
        description: "Капуста на гриле и цедра лимона - мое все!",
        age: 26,
      ...
      {
        id: 5,
        name: "Миша Тереньтьев",
        description: "Предпочитаю стейк без лишних слов и взглядов!",
        age: 31,
